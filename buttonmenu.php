...
<div style="width:100%">
<div style="margin-right:6px;" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label"><i style="font-weight:bolder" class="far icon-badge"></i></span> Prepress</div>
<div style="margin-right:6px;" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label"><i style="font-weight:bolder"  class="far icon-phone"></i></span> CallTag</div>
<div style="margin-right:6px;" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label"><i style="font-weight:bolder"  class="far fa-seedling"></i></span> Create</div>
<div style="margin-right:6px;" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label"><i style="font-weight:bolder"  class="far fa-hourglass-half"></i></span> Produce</div>

...
<div style="width:100%">
<div style="margin-right:6px;" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label"><i style="font-size:16px;" class="far icon-badge"></i></span> Prepress</div>

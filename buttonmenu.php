...
<div style="margin-right:6px;" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label"><i class="far f006mdi-account-box"></i></span> Install</div>
